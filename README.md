# Pluvia - Sistema Inteligente de Alertas para Enchentes
...
```bash
git clone https://github.com/Pluvia-GS/TecnoAlerta-WebDev.git
```

2. Navegue até o diretório do projeto
```bash
cd TecnoAlerta-WebDev
```
...
### Impacto Social
- Evaciações coordenadas e eficientes
